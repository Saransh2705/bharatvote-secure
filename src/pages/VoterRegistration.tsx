      ...
      <div className="govt-section">
        <div className="container mx-auto px-4 max-w-lg">
          ...
          <div className="flex gap-2 mb-4">
            {[0, 1, 2].map(i => (
              <div key={i} className={`flex-1 h-20 rounded border-2 border-dashed flex items-center justify-center overflow-hidden ${
                capturedImages[i] ? 'border-green-india' : 'border-border'
              }`}>
                {capturedImages[i] ? (
