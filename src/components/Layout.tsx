                ...
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`px-3 py-2 text-sm rounded ${
                      location.pathname === link.path ? 'bg-primary-foreground/20 font-medium' : ''
                    }`}
                  >
                    {link.label}
                  </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-1 opacity-80">
                <li><Link to="/elections" className="hover:underline">Elections</Link></li>
                <li><Link to="/register" className="hover:underline">Voter Registration</Link></li>
